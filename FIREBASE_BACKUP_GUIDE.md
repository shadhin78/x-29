...
Configured via `scripts/setup-task.ps1` with task name **`X-29 Automatic Backup`** running **4 times every 24 hours** with a strict **6-hour interval** between each backup:
