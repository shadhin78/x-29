...
$Triggers = @(
    ...
    (New-ScheduledTaskTrigger -Daily -At "10:05PM"),
...
Write-Host "Task '$TaskName' updated with 5 daily triggers (11:00 AM, 02:30 PM, 07:30 PM, 10:05 PM, 11:00 PM) successfully."
